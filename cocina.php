...
try {
    // Recuperar los productos que sean de la categoría 'cocina'
    $stmt = $pdo->prepare("SELECT * FROM catalogo WHERE categoria = :categoria");
    $stmt->bindParam(':categoria', $categoria);
    $categoria = 'cocina';  // Definir la categoría como 'cocina'
    $stmt->execute();
...
<head>
  ...
  <title>Catálogo de Cocina - Muebles</title>
  <style>
    body {
      ...
      <?php if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0): ?>
        ...
        ?>
          <div class="cart-item">
            ...
            <a href="cocina.php?remove_from_cart=<?php echo $item['id']; ?>" class="cart-item-remove">×</a>
          </div>
        <?php endforeach; ?>
        ...
        <?php if (!empty($productos)): ?>
          <?php foreach ($productos as $producto): ?>
            <div class="product-card">
              ...
              <a href="cocina.php?add_to_cart=<?php echo $producto['id_producto']; ?>" class="btn">Agregar al carrito</a>
            </div>
          <?php endforeach; ?>
        <?php else: ?>
